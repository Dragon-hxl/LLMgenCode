...
if __name__=="__main__":
    ...
    #     "UT_SBSP10_7b16k_pT",
    #     "UTfeedback_moretests_7b16k_pT_@10",
    #     "UTfeedback_moretests_7b16k_pT_@1",
    #     "UT_SBSPCODET4_7b16k_pT_pass@1",
    #     "UT_SBSPCODET4_7b16k_pT"]
    # for label,value in cir_record.items():
    #     if label not in show_label:
    #         continue
    #     data[label] = [round((1.0*x)/164*100,1) for x in value]
    # draw_plots_percent(data, color_map, "../image/UTfeedback_7b16k_moretests.jpg")
